...
static int mptsas_hard_reset(MPTSASState *s)
{
    ...
    mptsas_config_pages_free(s);
    mptsas_init_config_pages(s);
...
static void mptsas_scsi_sas_init(PCIDevice *dev, Error **errp)
{
...
static void mptsas1068_class_init(ObjectClass *oc, void *data)
{
    ...
    pc->realize = mptsas_scsi_sas_init;
