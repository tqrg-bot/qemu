...
typedef struct BlkMigDevState {
     ...
     * Allocation/free happens at the same time as the BlkMigDevState
     * itself, under the iothread lock.
     */
...
static int mig_save_device_bulk(QEMUFile *f, BlkMigDevState *bmds)
{
     ...
     * AioContext.
     *
     * This is ugly and will disappear when we make bdrv_* acquire
     * the AioContext.
     */
    qemu_mutex_lock_iothread();
