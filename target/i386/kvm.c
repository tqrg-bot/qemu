...
void kvm_arch_on_sigbus_vcpu(CPUState *c, int code, void *addr)
{
    ...
    /* Because the MCE happened while running the VCPU, we can inject
     * action required MCEs too and see what the guest does about them.
     * Action required MCEs from the I/O thread are not recoverable.
     */
